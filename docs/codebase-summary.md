...
│       │   ├── attachments/  # Media Staging, Magic byte sniffing, Ticket-based Streaming, Orphan cleanup cron
...
│       │   │   ├── attachment-downloader.ts    # Tải stream tệp đính kèm ngoài có giới hạn byte & SSRF filter
